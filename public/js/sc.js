...
$(document).ready(function () {
  $(document).on('click', '#edit_but', function () {
    ...
    $.ajax({
      ...
      success: function (response) {
console.log('✌️response --->', response.product.product_id);
        ...
        $('.product_dis').val(response.product.product_dis)
        $('.product_price').val(response.product.product_price)
        $('.orignal_price').val(response.product.orignal_price)
...
$(document).on('click', '#edit_sbbtn', function () {
  ...
  var orignal_price = $('#edit_ogprice').val();
  var formdata = new FormData();
  formdata.append('product_category', product_category);
  formdata.append('product_id', product_id);
  formdata.append('product_name', product_name);
  ...
  $(document).on('click', '#show_but', function () {
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        $('.show_id').val(response.product.product_id);
        $('.show_name').text(response.product.product_name);
        $('.show_category').text(response.product.product_category);
        $('.show_dis').text(response.product.product_dis);
        $('.show_price').text(response.product.product_price + ' ₹ ');
        $('.orignal_price').text(response.product.orignal_price);
        
        $(document).ready(function () {
          // Use response.product.product_image as a comma-separated string of image URLs
          const images = response.product.product_image.split(',');
